...
<div class="related">
	<h3><?php echo __('Related Client Attributes');?></h3>
	<?php if (!empty($client['ClientAttribute'])):?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
		<th><?php echo __('Name'); ?></th>
	...
	<?php
		$i = 0;
		foreach ($client['ClientAttribute'] as $clientAttribute): ?>
		<tr>
			<td><?php echo $clientAttribute['id'];?></td>
			<td><?php echo $clientAttribute['name'];?></td>
			<td class="actions">
				<?php echo $this->Html->link(__('View'), array('controller' => 'client_attributes', 'action' => 'view', $clientAttribute['id'])); ?>
				<?php echo $this->Html->link(__('Edit'), array('controller' => 'client_attributes', 'action' => 'edit', $clientAttribute['id'])); ?>
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'client_attributes', 'action' => 'delete', $clientAttribute['id']), null, __('Are you sure you want to delete # %s?', $clientAttribute['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
