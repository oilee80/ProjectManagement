<div class="projectAttributes index">
	<h2><?php echo __('Project Attributes');?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $projectAttribute['ProjectAttribute']['id']), null, __('Are you sure you want to delete # %s?', $projectAttribute['ProjectAttribute']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
